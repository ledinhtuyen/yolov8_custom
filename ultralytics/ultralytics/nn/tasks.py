...
class CustomModel(BaseModel):
    def __init__(self, cfg="yolov8n-custom.yaml", ch=3, nc=None, verbose=True, *args, **kwargs):
...
def attempt_load_one_weight(weight, device=None, inplace=True, fuse=False, *args, **kwargs):
    ...
    ckpt, weight = torch_safe_load(weight, *args, **kwargs)
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    nc_vtgp, nc_quality = (d.get(x) for x in ("nc_vtgp", "nc_quality"))
